...
print_build_help () {
    ...
    echo -e "\t${boldf}-t, --cpu_bus_test${normf} ${underlinef}CPU_BUS_TEST${normf}\n\t\tInclude a readback register set for the CPU bus and ELA the bus signaling."
    echo -e "\t\tThe FPGA firmware must be built with this switch in order to run the EPM11-MCU 'cpu_bus_test.py' test program.\n"
